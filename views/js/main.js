...
function updatePositions() {
  ...
  // let's prevent to much call by storing variables
  var scrollTop = latestKnownScrollY;
  var phase = [];

  // first we calculate the new positions
  ...
  requestAnimationFrame(applyNewPosition);
  ...
  // ticking is now false because we finished executing the function
  ticking = false;
}
